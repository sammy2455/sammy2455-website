        ...
        {post.cover ? (
          ...
          <div style={{ position: "relative", marginBottom: 0 }}>
            <div style={{
              ...
              <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "2rem 0" }}>
                <div className="container-main" style={{ maxWidth: 800 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", flexWrap: "wrap" }}>
                    {formattedDate && (
                      <span style={{ display: "flex", alignItems: "center", gap: "0.35rem", fontSize: "0.78rem", color: "rgba(255,255,255,0.7)" }}>
          ...
          <div style={{
            ...
            <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 1.5rem" }}>
              ...
              <div style={{
                ...
                {formattedDate && (
                  <span style={{ display: "flex", alignItems: "center", gap: "0.35rem", fontSize: "0.75rem", color: "var(--color-text-tertiary)" }}>
                    <IconCal /> {formattedDate}
                  </span>
                )}
