...
const timeline = [
    {company: "Clínica Santa Martha", title: {es: "Pasante de Sistemas", en: "Systems Intern"}, date: "2018"},
    {company: "HE-LLO S.A.", title: {es: "Desarrollador Backend", en: "Backend Developer"}, date: "2022 – 2023"},
    {company: "CHIANG SA", title: {es: "Ingeniero de Software", en: "Software Engineer"}, date: "2023"},
    {
        company: "SV TECHNOLOGY S.A.",
        title: {es: "Dev Semi Senior Full-Stack", en: "Semi Senior Full-Stack Dev"},
        date: "2023"
    },
    {company: "EXPAUSA S.A.", title: {es: "Ingeniero I+D", en: "R&D Engineer"}, date: "2023 – 2024"},
    {company: "Acatha S.A.", title: {es: "Desarrollador de Software", en: "Software Developer"}, date: "2024 –"},
];
...
export default function HomePage() {
    ...
    return (
      ...
      ══════════════════════════════════════════════════════ */}
            ...
            >
                {/* Badge disponibilidad — controlado por siteConfig.AVAILABLE_FOR_WORK */}
            ...
            <span className="pill pill-green">
              <span style={{
                ...
                >
                    {t("greeting")}{" "}
                    <span style={{color: "var(--color-accent)"}}>{t("name")}</span>
            ...
            >
                ...
                <div className="container-main">
                    ...
                    <div className="about-intro-grid"
                         style={{display: "grid", gridTemplateColumns: "1fr", gap: "3rem", marginBottom: "5rem"}}>
                        <div style={{
                            display: "flex",
                            flexDirection: "column",
                            gap: "1rem",
                                ...
                                {timeline.map((item, i) => {
                                    ...
                                    return (
                                        <div key={i} style={{position: "relative"}}>
                                            <div style={{
                                                position: "absolute", left: "-21px", top: 6,
                        ...
                        <div>
                            <div style={{display: "flex", flexDirection: "column", gap: "0.75rem"}}>
                                {interests.map(({icon, key}) => (
                                    <div key={key} className="card-apple" style={{
