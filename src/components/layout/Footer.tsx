      ...
      <div className="container-main">
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.625rem" }}>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "0.82rem", color: "var(--color-text-secondary)", textDecoration: "none" }}
              >
                <IconGithub />
        ...
        <div style={{
          ...
          <p style={{
            ...
            <span style={{ color: "#e74c3c" }}><IconHeart /></span>
            {locale === "es" ? "por" : "by"}{" "}
